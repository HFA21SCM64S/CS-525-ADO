...
printf("Testing file Original: Working at point 1 \n");  
  testInsertAndFind();
printf("Testing file Original: Working at point 2 \n");
  testDelete();
printf("Testing file Original: Working at point 3 \n");
  testIndexScan();
printf("Testing file Original: Working at point 4. All tests working. \n");
